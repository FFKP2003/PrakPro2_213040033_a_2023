...
public class HelloMessageDialog extends JFrame {
    public HelloMessageDialog() { // baris ini adalah sebuah konstruktor
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                /* 
                   baris ini untuk menampilkan pesan dengan HelloMessageDialog lalu tulis nama tittle nya 
                   dan type pesan apa yang ingin anda tampilkan disini saya menggunakan semua JOptionPane
                */
               JOptionPane.showMessageDialog(HelloMessageDialog.this, 
                "Hello, Selamat Datang di prakitikum pemograman II.","Faqih",JOptionPane.ERROR_MESSAGE); 
               
               JOptionPane.showMessageDialog(HelloMessageDialog.this, 
                "Hello, Selamat Datang di prakitikum pemograman II.","Firdaus",JOptionPane.INFORMATION_MESSAGE); 
               
               JOptionPane.showMessageDialog(HelloMessageDialog.this, 
                "Hello, Selamat Datang di prakitikum pemograman II.","Kemal",JOptionPane.WARNING_MESSAGE); 
               
               JOptionPane.showMessageDialog(HelloMessageDialog.this, 
                "Hello, Selamat Datang di prakitikum pemograman II.","Pangestu",JOptionPane.QUESTION_MESSAGE);
               
               JOptionPane.showMessageDialog(HelloMessageDialog.this, 
                "Hello, Selamat Datang di prakitikum pemograman II.","FFKP",JOptionPane.PLAIN_MESSAGE); 
            }         
        });
    ...
    public static void main(String[] args) {
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                HelloMessageDialog f = new HelloMessageDialog();
                f.setVisible(true);
            }
        });
    }
